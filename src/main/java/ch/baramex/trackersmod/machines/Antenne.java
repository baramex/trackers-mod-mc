...
public class Antenne extends Block {
	...
	List<String> tooltip = Arrays.asList(new String[]{TextFormatting.DARK_GREEN + new TextComponentTranslation("tooltip." + Reference.MODID + ".antenna").getFormattedText()});

	public Antenne(Material materialIn, String name) {
		super(materialIn);

...
public class ModItems {
	...
	public void initItems() {
		...
		anti_tracker = new ItemToolTip(Arrays.asList(new String[]{"§2If you carry it, it will prevent normal trackers from tracking you"})).setUnlocalizedName("anti_tracker").setRegistryName("anti_tracker").setCreativeTab(Main.tabsMod).setMaxStackSize(1);

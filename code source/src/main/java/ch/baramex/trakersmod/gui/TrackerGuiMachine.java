...
import ch.baramex.trakersmod.network.packetSyncRequestTrack;
...
public class TrackerGuiMachine extends GuiContainer {
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        fontRenderer.drawString("Tracker", 5 + guiLeft, 5 + guiTop, Color.BLACK.getRGB());
    	...
    	if(result != "") {
    		drawCenteredString(fontRenderer, "coordinate", guiLeft+xSize/2, guiTop+90, Color.GREEN.getRGB());
